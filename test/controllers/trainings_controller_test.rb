...
class TrainingsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create training" do
    assert_difference('Training.count') do
      post trainings_url, params: { training: { created_date: @training.created_date, kcal: @training.kcal, mileage: @training.mileage } }
    end
  ...
  test "should update training" do
    patch training_url(@training), params: { training: { created_date: @training.created_date, kcal: @training.kcal, mileage: @training.mileage } }
